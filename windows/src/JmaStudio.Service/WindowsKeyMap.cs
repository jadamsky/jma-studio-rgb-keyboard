...
// library's own normalized name strings, since this service installs
...
//
// Verified empirically in JmaStudio.HardwareTest (same table) during
// interactive testing this session -- carried over here unchanged.
